...
class User implements UserInterface
{
    ...
    public function getDomination(): ?string
    {
        return $this->domination;
    }

    public function setDomination(?string $domination): self
    {
    ...
    public function getReinit(): ?int
    {
        return $this->reinit;
    }

    public function setReinit(?int $reinit): self
    {
        $this->reinit = $reinit;
